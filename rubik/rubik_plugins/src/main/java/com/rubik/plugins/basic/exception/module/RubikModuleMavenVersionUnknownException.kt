 ...
 * @since 1.8
 */
internal class RubikModuleMavenVersionUnknownException(val path: String,val variant: String) : RubikException() {
    override fun toString() = "RubikModuleMavenVersionUnknownException project:$path " +
