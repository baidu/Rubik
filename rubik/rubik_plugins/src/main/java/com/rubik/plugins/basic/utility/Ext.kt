...
object Ext {
    ...
    const val RUBIK_AUTO_APPLY_ROOT_PLUGIN = "rubik_auto_apply_root_plugin"
    const val RUBIK_AUTO_APPLY_TEST_PLUGIN = "rubik_auto_apply_test_plugin"

    const val RUBIK_CONFIG_FILE_DIRS = "rubik_config_file_dirs"

    const val MODULES_SNAPSHOT_ENABLE = "modules_snapshot_enable"
    const val MODULES_SNAPSHOT_MAVEN_DEFAULT_GROUP_ID = "modules_snapshot_maven_default_group_id"
